...
export const games = [
  ...
  game({
    ...
    rules: ['On your turn choose Hit to receive a card or Stay to bank the round.', 'A repeated number makes you bust for zero.', 'Resolve Action cards immediately and place Modifier cards above your number row.', 'Seven different number cards ends the round and awards a 15-point bonus.'],
    scoring: 'The table winner earns 2 individual points and 2 points for their team.',
